...
GitHub Actions workflows that lint, build, and test Baton on every push to `main` and every pull request, across macOS and Linux (Windows best-effort), with build output parsed by `xcsift`.
