...
The `render` capability turns a saved Baton run record into local and GitHub-shaped output formats purely from on-disk artifacts, never re-invoking any agent or LLM.
