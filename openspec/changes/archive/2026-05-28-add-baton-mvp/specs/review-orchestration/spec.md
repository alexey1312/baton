...
Assembling agent prompts, running `(scope, review)` tasks concurrently, parsing agent responses into findings, writing run artifacts, and computing review pass/fail and exit semantics.
